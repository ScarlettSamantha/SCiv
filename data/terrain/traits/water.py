...
from world.terrain.traits.land import buildable
...
water = (
    TileModifier("walkable", False),
    TileModifier("climbable", False),
    TileModifier("flyable", True),
    TileModifier("space_above", True),
) + sailable

...
class DisplayMode(Enum):
    SHOW_ALWAYS = 0b00000000  # int: 0
    HIDE_ON_UNIT = 0b00000001  # int: 1
    HIDE_ON_RESOURCE = 0b00000010  # int: 2
    HIDE_ON_SELECT = 0b00000100  # int: 4
    CLEAR_CENTER_SLOT = 0b00001000  # int: 8
    OVERRULES_RESOURCE_MODEL = 0b00010000  # int: 16
    CITY_IMPROVEMENT = 0b00100000  # int: 32
    HIDE_ON_RESOURCE_IMPROVEMENT = 0b01000000  # int: 64
    RESOURCE_IMPROVEMENT = 0b10000000  # int: 128

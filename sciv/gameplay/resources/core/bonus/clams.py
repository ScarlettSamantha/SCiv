...
class Clams(BaseBonusResource):
    ...
    name: T_TranslationOrStr = t_("content.resources.core.clams.name")
    description: T_TranslationOrStr = t_("content.resources.core.clams.description")
    _color = (1.0, 0.0, 1.0)
    icon: str = "assets/icons/default/resources/core/bonus/hex_border_clams.png"
    spawn_chance: float | Dict[Type[BaseTerrain], float] = {Sea: 10.0, Coast: 90.0, SeaIce: 0.0, Lake: 55.0}
    spawn_amount = 3.0

...
from world.terrain._base_terrain import BaseTerrain
from world.weather._base_weather import BaseWeather
...
class Tile(Entity):
    def __init__(self, tile: tile, position: Vec3, x: int, y: int, **kwargs):
        self.tile: tile = tile
        ...
        super().__init__(
            model=self.tile.model(),
            texture=self.tile.texture(),
            position=position,
            **kwargs,
        )

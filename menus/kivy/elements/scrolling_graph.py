...
class ScrollingGraph(Widget):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.running: bool = False  # controls update
        ...
        # Pre-create line and blip instructions
        ...
        # Bind and initial draw
        self.bind(size=self._redraw_axis, pos=self._redraw_axis)  # type: ignore
        self._redraw_axis()

    def _redraw_axis(self, *_: Any) -> None:
        """
        Draw axes, tick marks, labels, and grid lines without using context managers.
        """
        # Clear previous axis instructions
    ...
    def pause(self) -> None:
        """Pause graph updates, retaining current data."""
        self.running = False

    def stop(self) -> None:
        """Stop updates and reset the graph to initial state."""
        self.running = False
        # clear data buffers
        ...
        # redraw axes and clear lines/blips
        self._redraw_axis()
    ...
    def update_graph(
        ...
        # Redraw axis if scale changed
        self._redraw_axis()

        # Update lines and blips
        graph_w = self.width - self.axis_margin  # type: ignore

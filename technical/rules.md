...
used in `gameplay/actions/unit/found.py` [Found.py](/gameplay/actions/unit/found.py)
...
- `unit_looses_movement_after_building` | default: `true` [Build.py](/gameplay/actions/unit/build.py) If the units MP will be set to 0 after building

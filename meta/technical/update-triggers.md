...
| `meta/**`, `scripts/generate_project_index.py`, `scripts/query_project_index.py`, `.github/**`, `.gitlab-ci.yml`, or `makefile` for docs/indexing/routing/agent-workflow work | [`../INDEX.md`](../INDEX.md), [`../structure.md`](../structure.md), [`agent-workflow.md`](agent-workflow.md) | `meta/INDEX.md`, this file, `agent-workflow.md`, and any affected routing or generated docs |

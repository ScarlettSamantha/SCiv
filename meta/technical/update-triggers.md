...
| `sciv/gameplay/vision.py`, vision/fog logic in `sciv/gameplay/player.py`, `sciv/gameplay/unit.py`, `sciv/gameplay/city.py`, or visibility refresh flow in `sciv/managers/world.py` / `sciv/managers/game.py` | [`vision-fog.md`](vision-fog.md), [`player-system.md`](player-system.md), [`turns.md`](turns.md), [`effects.md`](effects.md), and [`signals.md`](signals.md) | `vision-fog.md`, `player-system.md`, `turns.md`, `effects.md`, `signals.md`, and this file as needed |

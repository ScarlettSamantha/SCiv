...
class Fortifications(EngineerPromotion):
    def __init__(self, *args: Any, **kwargs: Any):
        super().__init__(
            ...
            description=t_(
                "content.units.core.promotions.engineer.fortifications.description"
            ),
            *args,
            **kwargs,
        )
...
class BridgeBuilding(EngineerPromotion):
    def __init__(self, *args: Any, **kwargs: Any):
        super().__init__(
            ...
            description=t_(
                "content.units.core.promotions.engineer.bridge_building.description"
            ),
            *args,
            **kwargs,
        )
...
class PowerLines(EngineerPromotion):
    def __init__(self, *args: Any, **kwargs: Any):
        super().__init__(
            ...
            description=t_(
                "content.units.core.promotions.engineer.power_lines.description"
            ),
            *args,
            **kwargs,
        )
...
class RenewableEnergy(EngineerPromotion):
    def __init__(self, *args: Any, **kwargs: Any):
        super().__init__(
            ...
            description=t_(
                "content.units.core.promotions.engineer.renewable_energy.description"
            ),
            *args,
            **kwargs,
        )
...
class CivilEngineering(EngineerPromotion):
    def __init__(self, *args: Any, **kwargs: Any):
        super().__init__(
            ...
            description=t_(
                "content.units.core.promotions.engineer.civil_engineering.description"
            ),
            *args,
            **kwargs,
        )
...
class EngineerPromotionTree(PromotionTree):
    ...
    def register_promotions(self):
        ...
        civil_engineering.requires = RequiresPromotionComplete(
            promotion=renewable_energy
        )

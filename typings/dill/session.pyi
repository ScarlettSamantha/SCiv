...
from ._dill import ModuleType, _reverse_typemap
...
IMPORTED_AS_MODULES = ...
IMPORTED_AS_MODULES = ...
def dump_module(filename: Union[str, os.PathLike] = ..., module: Optional[Union[ModuleType, str]] = ..., refimported: bool = ..., **kwds) -> None:
...
def dump_session(filename=..., main=..., byref=..., **kwds): # -> None:
    ...
...
def load_module(filename: Union[str, os.PathLike] = ..., module: Optional[Union[ModuleType, str]] = ..., **kwds) -> Optional[ModuleType]:
...
def load_session(filename=..., main=..., **kwds): # -> None:
    ...

def load_module_asdict(filename: Union[str, os.PathLike] = ..., update: bool = ..., **kwds) -> dict:
    """

...
def parent(obj, objtype, ignore=...): # -> None:
    """
...
def parents(obj, objtype, depth=..., ignore=...): # -> list[Any]:
...
def children(obj, objtype, depth=..., ignore=...): # -> list[Any]:
...
def find_chain(obj, predicate, edge_func, max_depth=..., extra_ignore=...): # -> list[Any]:
    ...

...
def capture(stream=...): # -> Generator[Any, Any, None]:
...
def dumpIO(object, **kwds): # -> BytesIO:
...
def loadIO_source(buffer, **kwds): # -> Any:
...
def dumpIO_source(object, **kwds): # -> BytesIO:

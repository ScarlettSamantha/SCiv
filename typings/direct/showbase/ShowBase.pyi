...
class ShowBase(DirectObject):
    ...
    def __init__(
        self, fStartDirect: bool = True, windowType: _WindowType | None = None
    ) -> None: ...
    ...
    def close_window(
        self, win: GraphicsOutput, keepCamera: bool = False, removeWindow: bool = True
    ) -> None: ...
    ...
    def setup_mouse(
        self, win: GraphicsWindow, fMultiWin: bool = False
    ) -> NodePath[ButtonThrower]: ...
    def setup_mouse_cb(
        self, win: GraphicsWindow
    ) -> tuple[list[NodePath[ButtonThrower]], list[MouseWatcher]]: ...
    ...
    def attach_input_device(
        self, device: InputDevice, prefix: str | None = None, watch: bool = False
    ) -> None: ...
    ...
    def create_stats(
        self, hostname: str | None = None, port: int | None = None
    ) -> bool: ...
    ...
    def change_mouse_interface(
        self, changeTo: NodePath[MouseInterfaceNode]
    ) -> None: ...
    ...
    def tkRun(self) -> None: ...
    def start_direct(
        self, fWantDirect: bool = ..., fWantTk: bool = ..., fWantWx: bool = ...
    ) -> None: ...
